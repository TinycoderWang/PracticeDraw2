...
public class Practice14MaskFilterView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 第一个：NORMAL
        BlurMaskFilter blurMaskFilter1 = new BlurMaskFilter(100, BlurMaskFilter.Blur.NORMAL);
        paint.setMaskFilter(blurMaskFilter1);
        canvas.drawBitmap(bitmap, 100, 50, paint);

        // 第二个：INNER
        BlurMaskFilter blurMaskFilter2 = new BlurMaskFilter(100, BlurMaskFilter.Blur.INNER);
        paint.setMaskFilter(blurMaskFilter2);
        canvas.drawBitmap(bitmap, bitmap.getWidth() + 200, 50, paint);

        // 第三个：OUTER
        BlurMaskFilter blurMaskFilter3 = new BlurMaskFilter(100, BlurMaskFilter.Blur.OUTER);
        paint.setMaskFilter(blurMaskFilter3);
        canvas.drawBitmap(bitmap, 100, bitmap.getHeight() + 100, paint);

        // 第四个：SOLID
        BlurMaskFilter blurMaskFilter4 = new BlurMaskFilter(100, BlurMaskFilter.Blur.SOLID);
